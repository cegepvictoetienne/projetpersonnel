...
pre-build: install
	...
	$(VENV_BIN)/python $(SCRIPTS_DIR)/generer_horaire.py --titre_page "Horaire rencontre" --chemin_excel template/horaire-rencontres.xlsx --chemin_markdown $(DOCS_DIR)/horaire_rencontres.md
	$(VENV_BIN)/python $(SCRIPTS_DIR)/generer_evaluation.py --modele template/projet_personnel.md --chemin_excel template/grille_correction.xlsx --chemin_markdown $(DOCS_DIR)/projet_personnel.md
